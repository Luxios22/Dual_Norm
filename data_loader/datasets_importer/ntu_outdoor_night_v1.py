...
class NTU_Outdoor_Night_V1(BaseImageDataset):
    """
    NTUIndoor
    Reference:
    ...
    """
    dataset_dir = 'NTU_Outdoor_Night_V1'

    def __init__(self, cfg, verbose=True, **kwargs):
        super(NTU_Outdoor_Night_V1, self).__init__()
        ...
        if verbose:
            print("=> NTU Outdoor Night V1.0 Loaded")
