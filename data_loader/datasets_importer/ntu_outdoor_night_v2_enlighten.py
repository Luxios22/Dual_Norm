...
class NTU_Outdoor_Night_V2_Enlighten(BaseImageDataset):
    """
    NTUIndoor
    Reference:
    ...
    """
    dataset_dir = 'NTU_Outdoor_Night_V2_Enlighten'

    def __init__(self, cfg, verbose=True, **kwargs):
        super(NTU_Outdoor_Night_V2_Enlighten, self).__init__()
        ...
        if verbose:
            print("=> NTU Outdoor Night Enlighten V2.0 Loaded")
    ...
    def _process_dir(self, dir_path, relabel=False):
        ...
        for img_path in img_paths:
            pid = os.path.basename(img_path).split('_')[5]
