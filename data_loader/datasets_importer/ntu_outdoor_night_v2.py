...
class NTU_Outdoor_Night_V2(BaseImageDataset):
    """
    NTUIndoor
    Reference:
    ...
    """
    dataset_dir = 'NTU_Outdoor_Night_V2'

    def __init__(self, cfg, verbose=True, **kwargs):
        super(NTU_Outdoor_Night_V2, self).__init__()
        ...
        if verbose:
            print("=> NTU Outdoor Night V2.0 Loaded")
