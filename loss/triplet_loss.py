...
class TripletLoss(object):
    ...
    def __init__(self, cfg):
        self._margin = cfg.SOLVER.TRI.MARGIN
        self._normalize_feature = cfg.SOLVER.TRI.NORM_FEAT
        self._scale = cfg.SOLVER.TRI.SCALE
        self._hard_mining = cfg.SOLVER.TRI.HARD_MINING
        self._use_cosine_dist = cfg.SOLVER.TRI.USE_COSINE_DIST

    def __call__(self, global_features, targets,normalize_feature=False):
